...
| `UPLOAD_DIR` | No | `tmp/library` | Directory to store uploaded files |
| `PORT` | No | `1111` | Port for the FastAPI server |
| `MAX_FILE_SIZE` | No | `52428800` (50MB) | Maximum file size in bytes |
...
### Backend
Deploy the FastAPI application using any ASGI server like Uvicorn, Gunicorn, or Hypercorn.
